...
- **Power Systems**: 13.8s lead time for cascade detection, 45x sensitivity advantage for localized stress, 3.1-4.4x computational speedup over eigenvalue methods, zero nuisance alarms with persistence filtering
